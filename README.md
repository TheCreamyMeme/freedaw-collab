...
![An animated preview of Freedaw Collab drag and drop samples from the file browser](readme_media/freedaw-collab-drag-n-drop-samples.gif)
![Preview of freedaw audio editor](readme_media/freedaw-collab-knob-attatchments.gif)
...
![Preview of freedaw audio editor](readme_media/freedaw-collab-status-bar.gif)
